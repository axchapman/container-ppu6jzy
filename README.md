...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ppu6jzy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ppu6jzy.containers.anotherwebservice.com/
...
```
git clone git@github.com:axchapman/container-ppu6jzy.git
cd container-ppu6jzy
```
...
```
docker attach container-ppu6jzy
```
